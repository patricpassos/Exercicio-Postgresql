...
UPDATE tb_bloco SET inicio = TIMESTAMP WITH TIME ZONE '2017-09-25T11:00:00Z' WHERE id = 1;
UPDATE tb_bloco SET fim = TIMESTAMP WITH TIME ZONE '2017-09-25T14:00:00Z' WHERE id = 1;
