...
UPDATE tb_carro SET id = 1 WHERE placa = 'HDD9383';
UPDATE tb_carro SET id = 2 WHERE placa = 'PEH3837';
...
INSERT INTO tb_locacao_diaria (dias_previsto) VALUES (4);
INSERT INTO tb_locacao_diaria (dias_previsto) VALUES (4);

INSERT INTO tb_locacao_longo_periodo (id, porcentagem_desconto) VALUES (3, 50.0)

SELECT * FROM tb_locacao_longo_periodo;